...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/HsTuah/multivpn/main/ipsec"
...
bigecho "Persediaan VPN sedang dijalankan... Harap bersabar."

# Create and change to working dir
mkdir -p /opt/src
cd /opt/src

bigecho "Cuba mencari IP pelayan ini secara automatik..."
PUBLIC_IP=$(wget -qO- ipinfo.io/ip);

bigecho "Memasang pakej yang diperlukan untuk VPN..."
if [[ ${OS} == "centos" ]]; then
...
bigecho "Menyusun dan memasang Libreswan..."
...
bigecho "Mencipta konfigurasi VPN..."
