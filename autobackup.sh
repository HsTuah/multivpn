...
echo " Sila tunggu"
clear
echo " Autosandar Telah Dimulakan"
echo " Data Akan Disandarkan Secara Automatik pada 00:00 GMT +8"
exit 0
}
function stop() {
email=$(cat /home/email)
...
echo " Sila tunggu"
clear
echo " Autosandar Telah Dihentikan"
exit 0
}
...
echo "Sila masukkan e-mel anda"
read -rp "Email : " -e email
echo "Sila masukkan e-mel Kata Laluan anda"
...
echo -e "=============================="
read -rp "Sila Masukkan Nombor Yang Betul : " -e num
case $num in
1)
start
;;
